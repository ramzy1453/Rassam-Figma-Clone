...
export const renderCanvas = ({
  ...
  Array.from(canvasObjects, ([objectId, objectData]) => {
    util.enlivenObjects([objectData]).then(([enlivenedObject]) => {
      // set object id to enlivened object

      const object = enlivenedObject as FabricObject;
      ...
      // set active object to enlivened object
...
export const handleCanvasZoom = ({
  ...
  options: CanvasEvents & { e: WheelEvent };
  canvas: Canvas;
}) => {
