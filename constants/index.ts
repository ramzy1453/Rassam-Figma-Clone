...
export const LeftShapes: Record<string, any> = {
  Rect: shapeElements[0],
  Circle: shapeElements[1],
  Triangle: shapeElements[2],
  Line: shapeElements[3],
  Image: shapeElements[4],
  Freeform: shapeElements[5],
  IText: {
